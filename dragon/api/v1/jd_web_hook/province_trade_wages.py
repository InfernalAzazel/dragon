...
def register(router: APIRouter):
    @router.post('/province-trade-wages', tags=['省内直营业代工资-创建数据到->工资扣款（主表）'], description=doc)
    async def province_trade_wages(whi: WebHookItem, req: Request, background_tasks: BackgroundTasks):
        # 验证签名
        ...
        for value in deduction:
            ...
            await jd.query_update_data_one(
                ...
                data={
                    ...
                    'jzr': {'value': whi.data['jzr']['username']},  # 姓名
