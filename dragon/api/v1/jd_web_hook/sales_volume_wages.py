...
def register(router: APIRouter):
    @router.post('/sales-volume-wages', tags=['实销量/发货量工资单-创建数据到->工资扣款（主表）'], description=doc)
    async def sales_volume_wages(whi: WebHookItem, req: Request, background_tasks: BackgroundTasks):
        # 验证签名
