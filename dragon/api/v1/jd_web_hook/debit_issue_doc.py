...
def register(router: APIRouter):
    @router.post('/debit-issue-doc', tags=['借支出库单-创建数据到->营销_产品出库总表'], description=doc)
    async def debit_issue_doc(whi: WebHookItem, req: Request, background_tasks: BackgroundTasks):
        # 验证签名
