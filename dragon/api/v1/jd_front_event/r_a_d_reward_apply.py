...
def register(router: APIRouter):
    ...
    async def leave_apply(inputs: Inputs, token: Optional[str] = Header(None)):
        ...
        if inputs.source_form == '1':
            res = await jd_store_archives_form_1.get_form_data(
                data_filter={
                    "rel": "and",  # 或者"or"
                    "cond": [
                        {
            ...
            res = await jd_store_archives_form_2.get_form_data(
                data_filter={
                    "rel": "and",  # 或者"or"
                    "cond": [
                        {
            ...
            res = await jd_store_archives_form_3.get_form_data(
                data_filter={
                    "rel": "and",  # 或者"or"
                    "cond": [
                        {
            ...
            res = await jd_store_archives_form_4.get_form_data(
                data_filter={
                    "rel": "and",  # 或者"or"
                    "cond": [
                        {
            ...
            res = await jd_store_archives_form_5.get_form_data(
                data_filter={
                    "rel": "and",  # 或者"or"
                    "cond": [
                        {
            ...
            res = await jd_store_archives_form_6.get_form_data(
                data_filter={
                    "rel": "and",  # 或者"or"
                    "cond": [
                        {
