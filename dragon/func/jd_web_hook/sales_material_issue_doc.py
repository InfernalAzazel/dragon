...
def register(router: APIRouter):
    @router.post('/sales-material-issue-doc', tags=['销售物料出库单-创建数据到->物料出库单_总表'], description=doc)
    async def sales_material_issue_doc(whi: WebHookItem, req: Request, background_tasks: BackgroundTasks):
        # 验证签名
