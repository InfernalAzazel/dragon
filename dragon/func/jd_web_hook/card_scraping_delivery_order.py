...
def register(router: APIRouter):
    @router.post('/card-scraping-delivery-order', tags=['刮卡出库单-创建数据到->营销_产品出库总表'], description=doc)
    async def card_scraping_delivery_order(whi: WebHookItem, req: Request, background_tasks: BackgroundTasks):
        # 验证签名
